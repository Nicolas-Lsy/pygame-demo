...
while True :
	...
	if not game_over:
		print_text(font,0,0,"Level :"+str(len(snake.segments)),color=(255,0,0))
		print_text(font,0,20,"Position :"+str(snake.segments[0].X//32) +"," + str(snake.segments[0].Y//32),color=(255,0,0))
		print_text(font, 0, 50, "Auto: 'space' " )
	else:
